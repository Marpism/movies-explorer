      ...
      <main className='landing'>
        ...
        <section className='landing__about-me' id="about-me">
          ...
          <article className='landing__about-me-container'>
            ...
            <img className='landing__about-pic' src={pic} />
          </article>
        </section>
        <section className='landing__portfolio'>
          ...
          <ul className='landing__portfolio-container'>
            <li className='landing__link-box'>
              ...
              <a href='https://github.com/Marpism/how-to-learn' target='__blank' className='landing__portfolio-link'>↗</a>
            </li>
            <li className='landing__link-box'>
              <p className='landing__portfolio-text'>Адаптивный сайт</p>
              <a href='https://github.com/Marpism/russian-travel' target='__blank' src={arrowPic} className='landing__portfolio-link'>↗</a>
            </li>
            <li className='landing__link-box'>
              <p className='landing__portfolio-text'>Одностраничное приложение</p>
              <a href='https://github.com/Marpism/react-mesto-api-full-gha' target='__blank' className='landing__portfolio-link'>↗</a>
            </li>
